...
public class BookDaoImpl implements BookDao {
    ...
    public static String getType(Object o) { //获取变量类型方法bai
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("我要喊口号");
        String xxx = sc.next();
        System.out.println(xxx);
        System.out.println("要喊几次");
        int count = sc.nextInt();
        for (int i = 0; i < count; i++) {
            System.out.println(xxx);
        }
        System.out.println(getType(2 * 11 + 1));
        BookDao dao = new BookDaoImpl();
        System.out.println(dao.updateBookState("1", 1));
        System.out.println(ResultVO.success(dao.getBooks(), "轮播").toJSON());
        System.out.println(ResultVO.success(dao.getBooks("", 1, 5), "hello").toJSON());
    }
}
